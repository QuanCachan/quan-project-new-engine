 ...
 * @author qtran
 */
public class CommentaryInstruction extends AbstractTestInstruction {

    public CommentaryInstruction() {
        setType(InstructionType.COMMENT);
        setContinueOnFailOrError(true);
    }
